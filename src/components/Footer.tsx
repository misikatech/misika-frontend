    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Misika</h3>
            <p className="text-gray-400 mb-4">
              Your trusted online shopping destination for groceries, electronics, garments, and more.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={ROUTES.ORDERS} className="text-gray-400 hover:text-white transition-colors">
                  Track Order
                </Link>
              </li>
              <li>
                <Link to={ROUTES.REFUND} className="text-gray-400 hover:text-white transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link to={ROUTES.SHIPPING} className="text-gray-400 hover:text-white transition-colors">
                  Shipping Info
                </Link>
              </li>
              <li>
